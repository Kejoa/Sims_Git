...
class TraCIMobility : public BaseMobility
{
	public:
		...
		//  @KM - TraCIMobility() - MOD: getDirection()
        virtual Coord getDirection() const {
            return move.getDirection() ;
        }
        //  @KM - TraCIMobility() - MOD: getDistance(Coord pos)
        virtual double getDistance(Coord Pos) const {
            return move.getStartPos().distance(Pos);
        }
